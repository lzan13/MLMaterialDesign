...
/**
 * Created by lzan13 on 2016/8/19.
 * <p/>
 ...
 * </pre>
 */
public class MLLineIndicatorView extends View {
     ...
     * Progress的高度
     */
    private static final float STROKE_WIDTH = 36;

    /**
     * Progress Indicator的高度
     */
    private static final float ALERT_STROKE_WIDTH = STROKE_WIDTH * 1.5f;
    ...
    public MLLineIndicatorView(Context context) {
        this(context, null);
    }

    public MLLineIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MLLineIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        mAlertSize = getResources().getDimension(R.dimen.ml_size_16);
        mAlertColor = getResources().getColor(R.color.ml_blue_54);

        mProgressBackground = getResources().getColor(R.color.ml_blue_54);
        mProgressColor = getResources().getColor(R.color.ml_green_87);

        // 指示器属性
        mIndicatorTextSize = getResources().getDimension(R.dimen.ml_size_14);
        mIndicatorTextColor = getResources().getColor(R.color.ml_white_87);
        mIndicatorBackground = getResources().getColor(R.color.ml_green_54);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int textHeight = MLViewUtils.getTextHeight(mAlertTextPaint);
    ...
    private void drawAlertText(Canvas canvas) {
        // 画左侧文字
        int leftAlertY = MLViewUtils.getTextHeight(mAlertTextPaint);
        int leftContentY = mHeight - MLViewUtils.getTextBaseLine(mAlertTextPaint);
        canvas.drawText(mLeftAlert, 0, leftAlertY, mAlertTextPaint);
        canvas.drawText(mLeftContent, 0, leftContentY, mAlertTextPaint);

        // 画右侧文字
        int rightAlertX = mWidth - MLViewUtils.getTextWidth(mAlertTextPaint, mRightAlert);
        int rightContentX = mWidth - MLViewUtils.getTextWidth(mAlertTextPaint, mRightContent);
    ...
    private void drawProgress(Canvas canvas) {
        ...
        int textWidth = MLViewUtils.getTextWidth(textPain, mAlert);
        // 指示文字背景
    ...
    public void setIndicator(float start, float end, float progress, String alert) {
        ...
        int textWidth = MLViewUtils.getTextWidth(getIndicatorTextPaint(), mAlert);
